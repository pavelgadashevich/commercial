Magnetic = new(function() {
    ...
    var r = navigator.userAgent.toLowerCase().indexOf("android") != -1 || navigator.userAgent.toLowerCase().indexOf("iphone") != -1 || navigator.userAgent.toLowerCase().indexOf("ipad") != -1,
        ...
        k = [{
            ...
            particleFill: "rgba(255,255,255,0.3)",
            fadeFill: "transparent",
            useFade: false
        }];
    this.init = function() {
        ...
        if (e && e.getContext) {
            ...
            document.getElementById("keyboardRight").addEventListener("click",
                O, false);
            for (var a = 0; a < 4; a++) z({
...
function Particle() {
    ...
    this.angle = 0;
    this.speed = 0.01 + this.size / 4 * 0.01;
    this.force = 1 - Math.random() * 0.6;
    this.color = "#ffffff";
    this.orbit = 1;
    this.magnet = null
}
